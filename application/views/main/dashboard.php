...
<div class="card info-card backlogs-card">
                    ...
                    <div class="card-body">
                        <div class="card-breakdown mt-2">
                            <span><b>Total Closed Tickets:</b> <?= $finish; ?></span>
                            <hr class="mt-1 mb-1">
                            <span><b>Total Posted Tickets:</b> <?= $posted; ?></span>
                            <hr class="mt-1 mb-1">
                            <span><b>Total Ongoing Tickets:</b> <?= $ongoing; ?></span>
                            <hr class="mt-1 mb-1">
                            <span><b>Total Pending Tickets:</b> <?= $pending; ?></span>
                            <hr class="mt-1 mb-1">
                            <span><b>Total Backlogs Tickets:</b> <?= $pending + $ongoing ?></span>
                            <hr class="mt-1 mb-1">
